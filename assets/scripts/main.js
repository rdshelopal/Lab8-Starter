    ...
    try {
      ...
      for (const url of RECIPE_URLS) {
        try {
          ...
          console.error('Error fetching recipe from URL:', url, error);
        }
      }
      ...
      if (recipes.length === RECIPE_URLS.length) {
        ...
        // If not all recipes were fetched, reject the Promise
        reject(new Error('Not all recipes were fetched successfully.'));
      }
    } catch (error) {
